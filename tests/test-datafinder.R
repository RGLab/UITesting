...
test_that("selection panel is present", {
  ...
  expect_match(facets[[5]]$getElementText()[[1]], "Research focus")
  expect_match(facets[[6]]$getElementText()[[1]], "Assay")
  expect_match(facets[[7]]$getElementText()[[1]], "Day of Study")
  expect_match(facets[[8]]$getElementText()[[1]], "Gender")
  expect_match(facets[[9]]$getElementText()[[1]], "Race")
  expect_match(facets[[10]]$getElementText()[[1]], "Age")
  expect_match(facets[[11]]$getElementText()[[1]], "Sample Type")
  expect_match(facets[[12]]$getElementText()[[1]], "Study")
})
